...
import { DollarSign, TrendingUp, PiggyBank, Map } from 'lucide-react';
...
const RouteReport: React.FC = () => {
    ...
    useEffect(() => {
        const fetchLoansByRoute = async () => {
            ...
            try {
                // Fetch loans with details for calculation
    ...
    return (
        <Card title="Reporte Financiero por Ruta">
            <div className="mb-6">
            ...
            {selectedRouteId && !loading && (
                <>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                         <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
                            <div className="flex items-center mb-2">
                                <Map className="w-4 h-4 text-blue-600 dark:text-blue-400 mr-2"/>
                                <h4 className="text-sm font-medium text-blue-700 dark:text-blue-300">Capital en Ruta</h4>
                            </div>
                    ...
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Detalle de Préstamos en Ruta</h3>
